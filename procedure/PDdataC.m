            ...
            switch (an)
                ...
                case 'TK18052901', % %PD % %OK
                    dataPath = {
                              ...
                              'TK18052901/2018061901', 'con', 2, [1 6], [1:8], [], 5, [18 19 33], [15 34 37], [], [] % %opto fail?
                ...
                case 'TK18052902', % %PD % %OK
                    dataPath = {
                              ...
                              'TK18052902/2018061101', 'con', 6, [1 5], [1:8], [], 5, [], [], [], [] % % %clear tagging PV 24
                ...
                case 'TK18121401', % %PD % %OK
                    dataPath = {
                              'TK18121401/2018121901', 'con', 3, [1 5], [1:8], [], 5, [4], [2], [], []
                              'TK18121401/2018121902', 'con', 3, [1 5], [1:8], [], 4, [], [], [], []
                              'TK18121401/2018121903', 'con', 3, [1 5], [1:8], [], 3, [], [], [], []
                              'TK18121401/2018123001', 'con', 6, [1 5], [1:8], [], 5, [35], [34], [75], []
                              'TK18121401/2018123002', 'con', 6, [1 5], [1:8], [], 4, [], [], [], []
                              'TK18121401/2018123003', 'con', 6, [1 5], [1:8], [], 3, [], [], [], []
                              'TK18121401/2019010701', 'con', 6, [1 5], [1:8], [], 5, [ 12 ], [ 13 15 16 17 18 22 ], [12], []
                ...
                case 'TK19011801', % %PD % %OK
                    dataPath = {
                              ...
                              'TK19011801/2019020701', 'con', 7, [1 5], [1:8], [], 5, [19], [17], [], []
                ...
                case 'TK19012501', % %PD % %OK
                    dataPath = {
                              ...
                              'TK19012501/2019021301', 'con', 2, [1 5], [1:8], [], 5, [8 11 13], [10], [], []
        ...
        case '2019',
            ...
            switch (an)
                case 'TK19040101', % %PD % %OK
                    dataPath = {
                              'TK19040101/2019041001', 'con', 3, [1 5], [1:8], [], 5, [7 21 24 25 45 47], [1 26 27 28 46 47 48 49 50], [16 21 25 29], [] % %25:PV-tagging BEST, 29:PV-tagging good,21,23: inhibition  BEST, contra: 45,47(pv):(initial inihibition?), 49(pyr): excitation?
                              'TK19040101/2019041001', 'con', 3, [1 5], [1:8], [], 4, [], [], [], []
                              'TK19040101/2019041001', 'con', 3, [1 5], [1:8], [], 3, [], [], [], []
                              'TK19040101/2019041201', 'con', 6, [1 5], [1:8], [], 5, [7 11 16 28 46 49 51 52 57], [6 22 47 48 50 53 55 ], [38], [] % %38:PV-tag Good
                              'TK19040101/2019041201', 'con', 6, [1 5], [1:8], [], 3, [], [], [], []
                              'TK19040101/2019041707', 'con', 6, [1 5], [1:8], [], 5, [5 10 26 44 48 50], [1 11 12 25 42 45 46 47 52], [], [2] % %44:rebound,26:contra-PV inhibition
                              'TK19040101/2019041708', 'con', 6, [1 5], [1:8], [], 4, [], [], [], []
                              'TK19040101/2019041807', 'con', 3, [1 5], [1:8], [], 5, [3  40], [4 16 18 36 37 38 39], [], [5 11 18] % %18 rebound-inhibition?, 35::contra-?? inhibition
                              'TK19040101/2019041808', 'con', 3, [1 5], [1:8], [], 4, [], [], [], []
                              'TK19040101/2019041907', 'con', 3, [1 5], [1:8], [], 3, [], [], [], []
                              'TK19040101/2019041908', 'con', 3, [1 5], [1:8], [], 4, [], [], [], []
                              'TK19040101/2019042201', 'con', 6, [1 5], [1:8], [], 5, [16 17 29 32 33], [13 20 25 30 31], [28], [] % %contra: 16(pv):inhibition, 20,25(pyr):(inhibition), ipsi: ,28(pv):excitation,30(pyr):inhibition
                ...
                case 'TK19050801', % %PD % %OK
                    dataPath = {
                    'TK19050801/2019051401','con',3,[1 5],[1:8],[],5,[20 23 30 31],[16 17 25 26 27 29],[18 20 21 31],[]%%20:PV-tagging BEST2, 18:PV-tagging good, 21:PV mild
                              'TK19050801/2019051402', 'con', 3, [1 5], [1:8], [], 4, [], [], [], []
                              'TK19050801/2019051403', 'con', 3, [1 5], [1:8], [], 3, [], [], [], []
                              'TK19050801/2019051507', 'con', 6, [1 5], [1:8], [], 5, [3 4 10 15], [2 7 8 14], [], [] % %
                              'TK19050801/2019051508', 'con', 6, [1 5], [1:8], [], 4, [], [], [], []
                              'TK19050801/2019051707', 'con', 3, [1 5], [1:8], [], 5, [10 11 13 19 36 39], [9 12 14 15 16 17 18 35], [], [] % %
                              'TK19050801/2019051708', 'con', 3, [1 5], [1:8], [], 4, [], [], [], []
                              'TK19050801/2019051709', 'con', 3, [1 5], [1:8], [], 3, [], [], [], []
                              'TK19050801/2019052101', 'con', 6, [1 5], [1:8], [], 5, [1 17 24 35 48 53], [2 19 21 25 37 52], [], [] % %
                ...
                case 'TK19060301', % %PD 20220628 % % %OK
                    dataPath = {
                              ...
                              'TK19060301/2019061201', 'con', 3, [1 5], [1:8], [], 5, [4], [3 5 7 8], [11], [] % % %
        ...
        case '2019f',
            ...
            switch (an)
                ...
                case 'AZ20013101', %PD % %OK
                    dataPath = {
                              'AZ20013101/2020021901', 'con', 6, [1 5], [1:8], [], 5, [13 19 21], [11 17 18], [], [] % %no tagging
