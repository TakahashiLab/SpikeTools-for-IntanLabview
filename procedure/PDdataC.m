            ...
            switch (an)
                ...
                case 'TK18052901', % %PD % %OK
                    dataPath = {
                              ...
                              'TK18052901/2018061901', 'con', 2, [1 6], [1:8], [], 5, [33 ], [37], [], [] % %opto fail?
        ...
        case '2019',
            ...
            switch (an)
                case 'TK19040101', % %PD % %OK
                    dataPath = {
                              'TK19040101/2019041001', 'con', 3, [1 5], [1:8], [], 5, [7  45 47], [1  46 48 49 50], [25], [] % %25:PV-tagging BEST, 29: rebound, 21,23: inhibition  BEST, contra: 45,47(pv):(initial inihibition?), 49(pyr): excitation?
                           ...
                           %%   'TK19040101/2019041707', 'con', 6, [1 5], [1:8], [], 5, [4 5 24 26 37 39 52], [1 2  22 25 33 36 42 44 46], [], [] % %44:rebound,26:contra-PV inhibition
                              ...
                              'TK19040101/2019041807', 'con', 3, [1 5], [1:8], [], 5, [3 11 40], [4 8 36 37 38 39], [], [] % %18 rebound-inhibition?, 35::contra-?? inhibition
                ...
                case 'TK19050801', % %PD % %OK
                    dataPath = {
                    'TK19050801/2019051401','con',3,[1 5],[1:8],[],5,[20 23 31],[16 17 ],[18 20 21 ],[]%%20:PV-tagging BEST2, 18:PV-tagging good, 21:PV mild
                           ...
                           %%double   'TK19050801/2019051707', 'con', 3, [1 5], [1:8], [], 5, [10 11 13 19 36 39], [9 12 14 15 16  18 35], [], [] % %
                              'TK19050801/2019051708', 'con', 3, [1 5], [1:8], [], 4, [], [], [], []
                              'TK19050801/2019051709', 'con', 3, [1 5], [1:8], [], 3, [], [], [], []
                           %%double   'TK19050801/2019052101', 'con', 6, [1 5], [1:8], [], 5, [1 17 24 35  48], [2 19 21 25 39  52], [], [] % %
        ...
        case '2019f',
            ...
            switch (an)
                ...
                case 'AZ20031201', %PD % % noisy
                    dataPath = {
                            %double  'AZ20031201/2020032701', 'con', 3, [1 5], [1:8], [], 5, [], [], [], []
                              'AZ20031201/2020032702', 'con', 3, [1 5], [1:8], [], 4, [], [], [], []
                              'AZ20031201/2020032703', 'con', 3, [1 5], [1:8], [], 3, [], [], [], []
                            %double  'AZ20031201/2020032704', 'con', 6, [1 5], [1:8], [], 5, [11], [12], [], []
            ...
            switch (an)
                ...
                case 'AZ20031901', %PD % %OK
                    dataPath = {
                              ...
                              'AZ20031901/2020041304', 'con', 6, [1 5], [1:8], [], 5, [  34  40], [  39], [ 40 47], [] % %2,3,14: contra-excitation, 39:rebound-excitation
                ...
                case 'AZ20070101', %PD % %no spike
                    ...
                    %                    'AZ20070101/2020072901','con',3,[1 5],[1:3 7 8],[4:6],5,[],[],[],[]%very noisy
                      ...
                      %%double        'AZ20070101/2020072904', 'con', 6, [1 5], [1:3 7 8], [4:6], 5, [], [], [], [] % %8:rebound
            ...
            switch (an)
                case 'AZ20121501', %PD % %noisy
                    ...
                    %'AZ20121501/2021011404','con',6,[1 5],[1:8],[],5,[],[],[],[]%%no spike
                      ...
                      %%double        'AZ20121501/2021012001', 'con', 3, [1 5], [1:8], [], 5, [], [], [], [] % %
                ...
                case 'AZ21010701', %PD % %poor
                    dataPath = {
                          %double    'AZ21010701/2021030101', 'con', 3, [1 5], [1:8], [], 5, [], [], [], [] %5:contra-inhibition, 6:contra-rebound
