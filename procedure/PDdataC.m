            ...
            switch (an)
                ...
                case 'TK18052902', % %PD % %OK
                    dataPath = {
                              ...
                              'TK18052902/2018061101', 'con', 6, [1 5], [1:8], [], 5, [], [], [24], [] % % %clear tagging PV 24
                ...
                case 'TK18121401', % %PD % %OK
                    dataPath = {
                              ...
                              'TK18121401/2018123001', 'con', 6, [1 5], [1:8], [], 5, [35], [34], [], []
                              'TK18121401/2018123002', 'con', 6, [1 5], [1:8], [], 4, [], [], [], []
                              'TK18121401/2018123003', 'con', 6, [1 5], [1:8], [], 3, [], [], [], []
                              'TK18121401/2019010701', 'con', 6, [1 5], [1:8], [], 5, [ 12 ], [ 13 15 16 17 18 22 ], [], []
        ...
        case '2019',
            ...
            switch (an)
                case 'TK19040101', % %PD % %OK
                    dataPath = {
                              'TK19040101/2019041001', 'con', 3, [1 5], [1:8], [], 5, [7 24 25 45 47], [1 26 27 28 46 47 48 49 50], [25 29], [21 23] % %25:PV-tagging BEST, 29:PV-tagging good,21,23: inhibition  BEST, contra: 45,47(pv):(initial inihibition?), 49(pyr): excitation?
                              ...
                              'TK19040101/2019041807', 'con', 3, [1 5], [1:8], [], 5, [3 18 40], [4 16 36 37 38 39], [5], [9 16] % %18 rebound-inhibition?, 35::contra-?? inhibition
                ...
                case 'TK19050801', % %PD % %OK
                    ...
                    %'TK19050801/2019051401','con',3,[1 5],[1:8],[],5,[20 23 30 31],[16 17 25 26 27 29],[18 20 21 23 31],[17 22 24 25 26 29]%%20:PV-tagging BEST2, 18:PV-tagging good, 21:PV mild
                              ...
                              'TK19050801/2019051507', 'con', 6, [1 5], [1:8], [], 5, [3 4 10 15], [2 7 8 14], [36], [] % %
                              ...
                              'TK19050801/2019052101', 'con', 6, [1 5], [1:8], [], 5, [1 17 24 35], [2 19 21 25 37], [], [] % %
                ...
                case 'TK19060301', % %PD 20220628 % % %OK
                    dataPath = {
                              ...
                              'TK19060301/2019061201', 'con', 3, [1 5], [1:8], [], 5, [4], [3 5 7 8], [], [] % % %
            ...
            switch (an)
                ...
                case 'AZ19120501', %PD % %OK
                    dataPath = {
                              ...
                              'AZ19120501/2020020604', 'con', 6, [1 5], [1:8], [], 5, [7 9], [6 8], [], [] % %12,rebound spike
