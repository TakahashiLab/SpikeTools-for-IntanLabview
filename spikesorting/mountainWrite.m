function mountainWrite(basename,numOfElectrodes)
...
dataFolder2=fullfile(dataFolder,'ms');

for i=1:numOfElectrodes
    fn=fullfile(dataFolder,[name 'e' num2str(i) '.mat']);
    fprintf('loading %s\n',fn);
    load(fn,'x');
    fn=fullfile(dataFolder2,[name 'raw' num2str(i) '.mda']);
    fprintf('saving %s\n',fn);
    writemda16i(x,fn);
end
